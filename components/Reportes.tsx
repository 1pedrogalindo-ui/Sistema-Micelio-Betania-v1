...
export default function Reportes() {
  ...
  const generarReporteOperativo = () => {
    downloadServerPdf('/api/reports/operativo', 'Micelio_Betania_Reporte_Operativo.pdf');
  };

  const generarReporteFinanciero = () => {
    downloadServerPdf('/api/reports/financiero', 'Micelio_Betania_Reporte_Financiero.pdf');
  };

  const generarReporteInversionistas = () => {
    downloadServerPdf('/api/reports/inversionistas', 'Micelio_Betania_Reporte_Inversionistas.pdf');
  };
